...
## [0.7.12](https://github.com/misselvexu/deepagents/compare/deepagents==0.7.11...deepagents==0.7.12) (2026-09-01)
...
* **sdk:** expose `execute` exit code in artifact ([#5300](https://github.com/misselvexu/deepagents/issues/5300)) ([de8bfca](https://github.com/misselvexu/deepagents/commit/de8bfca8255d673c1e7860e8c158ed119238197e))


### Bug Fixes

* **sdk:** add `files` state only for state backends ([#5643](https://github.com/misselvexu/deepagents/issues/5643)) ([63c13f3](https://github.com/misselvexu/deepagents/commit/63c13f3e6bc79a5304e542178ac410b517c64c31))
* **sdk:** batch concurrent `ContextHubBackend` mutations ([#5471](https://github.com/misselvexu/deepagents/issues/5471)) ([822f7c9](https://github.com/misselvexu/deepagents/commit/822f7c9b02e6d99bdb46b5545bb2543783c01769))
...
* **sdk:** identify file-capable provider classes ([#5326](https://github.com/misselvexu/deepagents/issues/5326)) ([e5d5391](https://github.com/misselvexu/deepagents/commit/e5d53917c01aadcebe4e7e4a1974322033ae6c87))
* **sdk:** make `BackendProtocol.glob` recursive for bare patterns ([#5026](https://github.com/misselvexu/deepagents/issues/5026)) ([32f35d5](https://github.com/misselvexu/deepagents/commit/32f35d5e01f460549c10365eb569978909f5c969))
* **sdk:** offload conversation history to distinct session ID when summarizing ([#5470](https://github.com/misselvexu/deepagents/issues/5470)) ([fa55c52](https://github.com/misselvexu/deepagents/commit/fa55c52fe774462b2775c0d77dcf811d6dfd0e35))
...
* **sdk:** resolve exact-file `delete` targets with first-match-wins o… ([#5229](https://github.com/misselvexu/deepagents/issues/5229)) ([6dd2a7d](https://github.com/misselvexu/deepagents/commit/6dd2a7d2f83bd63844a987f6ec65ac9244ec8c5b))
* **sdk:** scrub multimodal content blocks unsupported by the model's profile ([#5194](https://github.com/misselvexu/deepagents/issues/5194)) ([bdc6104](https://github.com/misselvexu/deepagents/commit/bdc610445534ba339360f3988de6b50b60482f1d))
